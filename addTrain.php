    ...
    <body>
        <div class="demo">
            ...
            <form name="Registration" action="" method="POST">
                <div class="container">
                    <h1>Sign Up</h1>
                    <p>Please fill in this form to add train to system.</p>
                    <hr>
                    ...
                    <p>By adding a train you agree to our <a href="#" style="color:dodgerblue">Terms & Privacy</a>.</p>
            ...
            <?php
               ...
               {
                   $count=0;
                   $sql="SELECT trainID FROM `train`";
                   $result=mysqli_query($conn,$sql);

                   /*check if username is exist or not*/
                   while ($row=mysqli_fetch_assoc($result))
                   {
                       if($row['trainID']==$_POST['id'])
                       {
                           $count=$count+1;
                       }
                   }
                  if($count==0)   
                   {
                       mysqli_query($conn,"INSERT INTO `train` VALUES 
                       ('$_POST[id]','$_POST[type]','$_POST[cars_no]','$_POST[seats_no]');");
            ?>
