    ...
    <body>
        <div class="demo">
            ...
            <form name="Registration" action="" method="POST">
                <div class="container">
                    <h1>Sign Up</h1>
                    <p>Please fill in this form to add trip.</p>
                    <hr>
            ...
            <?php
               ...
               if(isset($_POST['submit']))
               {
                  ...
                  if($count==0)   
                   {
                       mysqli_query($conn,"INSERT INTO `trip` VALUES 
                       ('$_POST[trip_id]','$_POST[train_id]','$_POST[start]','$_POST[end]',' $_POST[time]','$_POST[date]',
                       '$_POST[degree]','$_POST[available_seats]','$_POST[price]');");
            ?>
