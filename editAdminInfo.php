...
<html>
    ...
    <body>
        ...
        <?php
         ...
         {
            if(mysqli_query($conn,"UPDATE `admin`SET user_name='$_POST[username]', user_password='$_POST[psw]',
            first_name='$_POST[firstName]',last_name='$_POST[lastName]',email='$_POST[email]' WHERE user_password='$_POST[cpsw]';"))
            {
                ?>
