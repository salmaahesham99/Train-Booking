...
<html>
    ...
    <body>
        <div class="demo">
            ...
            <form name="Update" action="" method="POST">
                <div class="container">
                    ...
                    <input type="password" id="password" placeholder="Enter Current Password" name="cpsw" required>
                    </br>

                    <label for="psw"><b>Password</b></label>
                    <input type="password" id="password1" placeholder="Enter Password" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
        ...
        <?php
         ...
         {
            if(mysqli_query($conn,"UPDATE `traveler`SET User_Password='$_POST[psw]' WHERE UAER_NAME='$_POST[username]' 
            AND User_Password='$_POST[cpsw]';"))
            {
                ?>
                <script type="text/javascript">
                    alert("The Password update successfuly...");
                </script>
                <?php
            }
